...
const WelcomeScreen = () => {
  ...
  return (
    <div>
      <WelcomeScreenHeader />
      <div className="flex items-center justify-center min-h-screen bg-[#fbf8f4] overflow-hidden">
        <div
          style={{
            backgroundImage: `url(${images[currentImageIndex]})`,
            width: isScrolled ? "100vw" : "412px", // Switch between square and full width
            height: isScrolled ? "656px" : "569px", // Maintain full viewport height
        ...
        >
          <div className="absolute top-[50px] left-0 w-full h-[656px] min-h-[656px] flex items-center justify-center z-0">
            {isScrolled && (
            ...
            <h2 className="mt-[132px] text-center text-[#0E4957] font-fugi 2xl:text-[72px] xl:text-[65px] lg:text-[60px] md:text-[50px] text-[36px] font-normal leading-[120%] tracking-[-0.36px] px-4 2xl:w-[55%] sm:w-[60%] w-full z-10 max-w-[800px] mx-auto">
              Welcome to The World of Infinite Vacations
            </h2>
            {isScrolled && (
              <div className="absolute bottom-[0px] sm:w-[412px] w-[300px] h-[190px] border-2 border-t-0 border-solid  border-[#0E4957]"></div>
            )}
          </div>
        </div>
      </div>
